...
public class JwtService {
    ...
    /**
     * Returns the expiration date of the token (public for logout TTL calculation).
     */
    ...
    /**
     * Calculates the remaining validity duration of a token.
     * Used by the logout flow to set the correct TTL in the blacklist.
     */
    public Duration getRemainingValidity(String token) {
        long expirationMs = getExpiration(token).getTime();
